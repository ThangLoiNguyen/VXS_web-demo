...
function Routing({ title, link }) {
  return (
    <div className='relative z-30 mb-10'>
      <div className='flex flex-col py-5 md:py-14 bg-sky-600 items-center justify-center gap-3 md:gap-8'>
      ...
      <div className=' flex flex-row gap-3 px-5 md:px-10 bg-sky-500 w-full py-5 md:py-10 items-center'>
