          ...
          <div className='px-6'>
            <form action="" className='flex flex-col gap-6'>
              <div className='flex flex-col gap-3'>
                <span>
                  <label htmlFor='username' className='text-sm font-semibold cursor-pointer select-none'>Enter your phone number</label>
                </span>
                <input
                  type="text"
                  id='username'
            ...
            <div className='flex w-full pt-6'>
              <button className='w-full px-3 py-2 bg-black hover:bg-gray-900 text-white text-sm rounded-full'>Register</button>
            </div>
          </div>
