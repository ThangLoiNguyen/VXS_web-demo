  ...
  return (
    <div className='absolute flex flex-row mx-auto top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-3/4 w-2/3 border-black border'>
      ...
      <div className='w-1/2 h-full px-5 py-5'>
        <span className='flex justify-center text-2xl font-bold py-6'>Sign Up</span>
        <div className='px-6'>
          <form action="" className='flex flex-col gap-6'>
            ...
            <div className='flex flex-col gap-3'>
              <span>
                <label htmlFor="password" className='text-sm cursor-pointer select-none'>Enter new password</label>
              </span>
              <input
          ...
          <div className='flex w-full pt-6'>
            <button className='w-full px-3 py-2 border border-black bg-white text-black text-sm hover:bg-black hover:text-white duration-300 rounded-full'>Register</button>
          </div>
        </div>
